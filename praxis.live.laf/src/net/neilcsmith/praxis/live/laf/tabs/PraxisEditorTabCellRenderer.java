...
package net.neilcsmith.praxis.live.laf.tabs;
...
class PraxisEditorTabCellRenderer extends AbstractTabCellRenderer {
     ...
     */
    public PraxisEditorTabCellRenderer() {
    ...
    private static class MetalTabPainter implements TabPainter {
        public Insets getBorderInsets(Component c) {
            PraxisEditorTabCellRenderer mtr = (PraxisEditorTabCellRenderer) c;
...
//                g.drawLine(3, ins.top + 17, 3, ins.top + 17);
        ...
        public void getCloseButtonRectangle(JComponent jc,
            ...
            String iconPath = findIconPath((PraxisEditorTabCellRenderer) jc);
        ...
        private void paintCloseButton(Graphics g, JComponent c) {
            if (((AbstractTabCellRenderer) c).isShowCloseButton()) {
                ...
                //paint close button
                String iconPath = findIconPath( (PraxisEditorTabCellRenderer)c );
                Icon icon = TabControlButtonFactory.getIcon( iconPath );
