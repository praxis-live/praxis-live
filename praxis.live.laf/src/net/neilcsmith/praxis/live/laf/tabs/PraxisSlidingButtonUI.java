 ...
 * @author  Milos Kleint
 */
public class PraxisSlidingButtonUI extends SlidingButtonUI {
    // Has the shared instance defaults been initialized?
    private boolean defaults_initialized = false;   
    protected JToggleButton hiddenToggle;
    
    private static final PraxisSlidingButtonUI INSTANCE = new PraxisSlidingButtonUI();

    private PraxisSlidingButtonUI() {
    }
