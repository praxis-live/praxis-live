 ...
 * @author Dafe Simonek
 */
public final class PraxisViewTabDisplayerUI extends AbstractViewTabDisplayerUI {
     ...
     */
    private PraxisViewTabDisplayerUI(TabDisplayer displayer) {
        super(displayer);
    ...
    protected void paintTabBackground(Graphics g, int index, int x, int y,
        ...
        if (highlighted && !attention) {
            ...
            g.setColor(PraxisEditorTabCellRenderer.ATTENTION_COLOR);
            g.fillRect(x, y, width, height - 3);
        } else {
