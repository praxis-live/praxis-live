...
final class CapturePanel extends javax.swing.JPanel {
    ...
    private void resetBtn1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_resetBtn1ActionPerformed
        devInput1.setText(getDefaultCaptureDevice(1));
        controller.changed();
    ...
    private void resetBtn2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_resetBtn2ActionPerformed
        devInput2.setText(getDefaultCaptureDevice(2));
        controller.changed();
    ...
    private void resetBtn3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_resetBtn3ActionPerformed
        devInput3.setText(getDefaultCaptureDevice(3));
        controller.changed();
    ...
    private void resetBtn4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_resetBtn4ActionPerformed
        devInput4.setText(getDefaultCaptureDevice(4));
        controller.changed();
    ...
    private void libPathResetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_libPathResetActionPerformed
        libPathTextField.setText(DEFAULT_LIBRARY_PATH);
        controller.changed();
    }//GEN-LAST:event_libPathResetActionPerformed

    void load() {
        devInput1.setText(getCaptureDevice(1));
        devInput2.setText(getCaptureDevice(2));
        devInput3.setText(getCaptureDevice(3));
        devInput4.setText(getCaptureDevice(4));

        libPathTextField.setText(Settings.get(KEY_LIBRARY_PATH, DEFAULT_LIBRARY_PATH));
    ...
    void store() {
        ...
        if (text.isEmpty() || text.equals(getDefaultCaptureDevice(1))) {
            resetCaptureDevice(1);
        } else {
            setCaptureDevice(1, text);
        }

        text = devInput2.getText().trim();
        if (text.isEmpty() || text.equals(getDefaultCaptureDevice(2))) {
            resetCaptureDevice(2);
        } else {
            setCaptureDevice(2, text);
        }

        text = devInput3.getText().trim();
        if (text.isEmpty() || text.equals(getDefaultCaptureDevice(3))) {
            resetCaptureDevice(3);
        } else {
            setCaptureDevice(3, text);
        }

        text = devInput4.getText().trim();
        if (text.isEmpty() || text.equals(getDefaultCaptureDevice(4))) {
            resetCaptureDevice(4);
        } else {
            setCaptureDevice(4, text);
        }

        text = libPathTextField.getText().trim();
        if (text.equals(DEFAULT_LIBRARY_PATH)) {
            Settings.put(KEY_LIBRARY_PATH, null);
        } else {
            Settings.put(KEY_LIBRARY_PATH, text);
        }
    ...
    private static String getCaptureDevice(int idx) {
        return Settings.get(KEY_CAPTURE_PREFIX + idx, getDefaultCaptureDevice(idx));
    }

    private static void resetCaptureDevice(int idx) {
        setCaptureDevice(idx, null);
    }

    private static void setCaptureDevice(int idx, String device) {
        if (idx < 1) {
    ...
    private static String getDefaultCaptureDevice(int idx) {
        if (idx < 1) {
            throw new IllegalArgumentException();
        }
    ...
    private static String getDefaultWindowsLibraryPath() {
        try {
            ...
            System.getLogger(CapturePanel.class.getName())
